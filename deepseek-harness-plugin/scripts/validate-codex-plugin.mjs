...
if (pkg.version !== '0.1.8' || plugin.version !== pkg.version || publicPlugin.version !== pkg.version) {
  throw new Error('package, Codex, and public Skills-only versions must all be 0.1.8')
}
